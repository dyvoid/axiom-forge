...
| 3 | Bidirectional / Inverse Fields | Accepted | [ADR-0004](adr/0004-bidirectional-inverse-fields.md) | Not yet built; display-first. Push prompt covers both add and remove; the 2 remaining open items (deletion, dangling targets) are decidable at build time, not user-blocked |
