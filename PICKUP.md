...
1. **[ADR-0004] Bidirectional / Inverse Fields** — Accepted. The one open product
...
2. **[ADR-0013] Project Scaffolding** — skeleton ADR only, and the only backlog item
...
Two architecture candidates remain in
