...
**[ADR-0008] YAML Frontmatter for Metadata** — core implementation is **complete and committed**
on branch `task/yaml-frontmatter-metadata` (`1906a50`).
...
3. Optionally opening a PR from `task/yaml-frontmatter-metadata` → `main`.
