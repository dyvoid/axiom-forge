...
| — | [`Axiom_Forge_Design_Tokens.md`](Axiom_Forge_Design_Tokens.md) | Typography, palette, spacing, component recipes — extracted from the Figma prototype |
| — | [`design/`](design/) | PNG mockups and prototype HTML exports |
